...
#### WP-C7 後勤體系化：補給類別、消耗、修復、整補　★★★｜golden：重錄　🟡 C7.1 ✅ 2026-07-30；C7.2/C7.3 未做
...
> 5. **未竟**：LOGISTICS capacity 的類別命名與 Class 編號不一致（要改契約，宜與 C7.2 一起）、
...
C7 後勤體系：C7.1 ✅ 補給類別（2026-07-30）→ C7.2 補給線 → C7.3 修復整補
